...
FOR %%x IN ("D:\project.plweb.20\plweb.webapp.java\WebContent\shared\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\project.plweb.20\plweb.webapp.java\WebContent\shared\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\project.plweb.20\plweb.webapp.java\WebContent\shared"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=d:\project.plweb.20\xampp\php\php.exe"
